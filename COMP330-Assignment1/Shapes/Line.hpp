...
public:
    ...
    Color::Color color;
    int stroke;
    Line(int _x1, int _y1, int _x2, int _y2, int _stroke, Color::Color _color): p1(new Point(_x1, _y1)), p2(new Point(_x2, _y2)), color(_color), stroke(_stroke) {dashed = false;};
